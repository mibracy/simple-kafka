...
public class BatchController {
    ...
    public void scheduleTaskUsingCronExpression() throws UnknownHostException {
        ...
        String randomUUID = InetAddress.getLocalHost().getHostName() +"-"+ UUID.randomUUID();
        ...
        KafkaPayload kP = new KafkaPayload(payMap.get("topic"), payMap.get("key"), payMap.get("value"));
